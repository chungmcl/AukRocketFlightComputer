...
void Altimeter::SetupAltimeter() 
{
    ...
    // Changed oversampling from 8X to 4X for temperature
    // Change oversampling from 4X to 2X for pressure
    theBmp.setTemperatureOversampling(BMP3_OVERSAMPLING_4X);
...
void Altimeter::AltimeterDebug() 
{
    ...
    Serial.print(GetAltitudeMeters(GROUNDLEVELPRESSURE_HPA));
    Serial.println(" m");
